      ...
      <aside className="w-64 bg-surface-900 flex flex-col flex-shrink-0">
        ...
        <div className="p-4 border-t border-surface-800">
          ...
          <button
            ...
            className="w-full text-left px-3 py-2 rounded-lg text-sm text-surface-400
              hover:text-white hover:bg-surface-800 transition-colors flex items-center gap-2"
          >
